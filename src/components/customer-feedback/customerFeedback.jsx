  ...
  const [reviews, setReviews] = useState([
    {
      ...
      name: "John Doe",
      text: "Great service!",
      replies: [{ id: 1, name: "Company", text: "Thank you!" }],
    },
    {
      id: 2,
      name: "Jane Smith",
      text: "I loved the quick response from support.",
      replies: [
        { id: 1, name: "Company", text: "We're glad you were satisfied!" },
      ],
    },
    ...
    { id: 5, name: "Charlie Davis", text: "Not what I expected.", replies: [] },
    {
      id: 6,
      name: "Diana Evans",
      text: "Would recommend to my friends!",
      replies: [],
    },
    {
      id: 7,
    ...
    },
    {
      id: 8,
      name: "Georgia Hill",
      text: "Superb experience with your service.",
      replies: [],
    },
    {
      id: 9,
      name: "Henry Irving",
      text: "I found the website difficult to navigate.",
      replies: [],
    },
    {
      id: 10,
      name: "Isabel Johnson",
      text: "Checkout process was seamless and fast.",
      replies: [],
    },
  ]);
