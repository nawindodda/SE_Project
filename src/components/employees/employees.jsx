...
const shifts = ['Morning (8 AM - 4 PM)', 'Afternoon (4 PM - 12AM)', 'Night (12AM - 8 AM)'];
...
const EmployeeSchedule = () => {
        ...
        const generateSchedule = () => {
            let schedule = days.map(day => ({
                ...
                shifts: shifts.map((shift, index) => ({
                    shift,
                    employee: employees[(days.indexOf(day) * shifts.length + index) % employees.length].name
                }))
            }));
            return schedule;
        };
    ...
    return (
        <div className="container mt-5">
            <h3 className="mb-3" style={{color: '#14738c'}}>Weekly Employee Schedule</h3>
