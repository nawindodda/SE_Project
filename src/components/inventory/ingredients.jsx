...
const ingredients = [
  ...
  { name: 'Brown Sugar', quantity: '60%', purpose: 'Sweetening', orderItem: false },
  { name: 'Cocoa Powder', quantity: '70%', purpose: 'Flavoring', orderItem: false },
  { name: 'Baking Powder', quantity: '90%', purpose: 'Leavening', orderItem: false },
  { name: 'Baking Soda', quantity: '85%', purpose: 'Leavening', orderItem: false },
  ...
  { name: 'Buttermilk', quantity: '50%', purpose: 'Flavoring', orderItem: false },
  { name: 'Cream', quantity: '70%', purpose: 'Moistening', orderItem: false },
  { name: 'Cream Cheese', quantity: '50%', purpose: 'Flavoring', orderItem: false },
  { name: 'Mascarpone Cheese', quantity: '40%', purpose: 'Flavoring', orderItem: true },
  { name: 'Whipped Cream', quantity: '80%', purpose: 'Topping', orderItem: false },
  { name: 'Vanilla Extract', quantity: '90%', purpose: 'Flavoring', orderItem: false },
  { name: 'Almond Paste', quantity: '70%', purpose: 'Flavoring', orderItem: false },
  { name: 'Sliced Almonds', quantity: '60%', purpose: 'Topping', orderItem: false },
  { name: 'Chocolate Chips', quantity: '80%', purpose: 'Flavoring', orderItem: false },
  { name: 'Cherries', quantity: '50%', purpose: 'Topping', orderItem: false },
  { name: 'Raspberries', quantity: '30%', purpose: 'Topping', orderItem: true },
  { name: 'Strawberries', quantity: '60%', purpose: 'Topping', orderItem: false },
  { name: 'Blueberries', quantity: '70%', purpose: 'Topping', orderItem: false },
  { name: 'Bananas', quantity: '40%', purpose: 'Topping', orderItem: true },
  { name: 'Apples', quantity: '50%', purpose: 'Topping', orderItem: false },
  { name: 'Pineapple Slices', quantity: '60%', purpose: 'Topping', orderItem: false },
  { name: 'Maraschino Cherries', quantity: '70%', purpose: 'Topping', orderItem: false },
  { name: 'Lemon Juice', quantity: '90%', purpose: 'Flavoring', orderItem: false },
  { name: 'Lemon Zest', quantity: '80%', purpose: 'Flavoring', orderItem: false },
  ...
  { name: 'Potatoes', quantity: '50%', purpose: 'Ingredient', orderItem: false },
  ...
  { name: 'Graham Crackers', quantity: '80%', purpose: 'Ingredient', orderItem: false },
  { name: 'Ladyfingers', quantity: '50%', purpose: 'Ingredient', orderItem: false },
  ...
  { name: 'Rum (optional)', quantity: '90%', purpose: 'Flavoring', orderItem: false },
  { name: 'Jam (any flavor)', quantity: '70%', purpose: 'Flavoring', orderItem: false },
